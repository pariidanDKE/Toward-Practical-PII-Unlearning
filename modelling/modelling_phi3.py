...
from modelling.configuration_phi3 import Phi3Config
...
class Phi3Model(Phi3PreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        tokens_to_mix: Optional[List] = None,
                        ...
                        if layer[l] == tot:
                            ...
                            if tokens_to_mix is not None:
                                for (b, e) in tokens_to_mix[l]:
                                    ...
                                    hidden_states[l, b:e] = hidden_states[l, b:e] + noise_data
                # === END CUSTOM BLOCK ===
    ...
    def forward(
        ...
        if output_hidden_states:
            ...
            for hid in outputs.hidden_states:
                log = self.lm_head(hid)
                log = log.float()
                all_layer_logits.append(log)
            ...
            return CausalLMOutputWithPast(
                loss=all_loss if labels is not None else None,

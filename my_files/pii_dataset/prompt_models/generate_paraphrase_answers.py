...
qapair_json_schema = get_more_paraphrase_json_schema()
...
user_profiles, raw_prompts = more_paraphrase_prompt(add_noise=False)
prompts = []

for prompt in raw_prompts:
    chat = [
    {"role": "system", "content": system_prompt_paraphrase_answer},

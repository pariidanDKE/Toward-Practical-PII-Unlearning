...
import pandas as pd
from prompt_gen_utils import invert_qa_prompt,get_invert_qa_json_schema,system_prompt_invert_qa
...
qapair_json_schema = get_invert_qa_json_schema()
...
user_profiles, raw_prompts = invert_qa_prompt(add_noise=False)
prompts = []

for prompt in raw_prompts:
    chat = [
    {"role": "system", "content": system_prompt_invert_qa},

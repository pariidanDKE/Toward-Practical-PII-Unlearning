...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        print('In the forward method of LlamaModel')
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            ...
            if layer is not None and tokens_to_mix is not None:
                #print(f'Running through layer {tot} of {len(self.layers)}')
                for l in range(len(layer)):
                    #print(f'Batch {l} adds noise to layer {layer[l]}, Check equal to {tot}')
                    if layer[l] == tot:
                        #print(f'Adding noise to input {l} with tokens_to_mix {tokens_to_mix[l]}')
                        import numpy

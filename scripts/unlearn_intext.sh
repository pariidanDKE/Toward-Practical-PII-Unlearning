...
#     export run_name="LoRAPII_${forget_loss}_${model}_r${LoRA_r}_a${LoRA_alpha}_"
...
#         run_name=$run_name \
#         #model_family.gradient_checkpointing=$gradient_checkpointing
...
export run_name="FullFT_PII_${forget_loss}_${model}_E${num_epochs}_B${batch_size}_G${gradaccum}_lr${lr}_W${retain_weight}_intext${in_text}_replaceprob${token_replace_prob}_topk${token_top_k}_answertagging"
export save_dir="$PWD/experiment/${dataset}/${model}/${split}/$run_name"
